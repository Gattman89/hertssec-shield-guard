        ...
        <nav className="hidden lg:flex items-center gap-8 mx-auto">
          {navLinks.map((l) => (
            <Link
              ...
              className="text-sm font-semibold text-foreground/85 hover:text-brand transition-colors uppercase tracking-wide"
            >
              {l.label}
            </Link>
          ))}
          ...
          <div className="px-4 py-4 flex flex-col gap-4">
            {navLinks.map((l) => (
              <Link
                ...
                className="text-sm font-semibold uppercase tracking-wide text-foreground/85"
              >
                {l.label}
              </Link>
            ))}
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 w-full pt-64 sm:pt-72 lg:pt-80 pb-16">
        <div className="max-w-3xl">
          ...
          <div className="mt-4 flex flex-wrap items-center gap-x-6 gap-y-2">
            <a href="tel:01992364110" className="inline-flex items-center gap-2 text-lg font-bold text-white hover:text-brand transition-colors">
              <Phone className="h-5 w-5 text-brand" /> 01992 364110
            </a>
            <a href="mailto:info@hertsshield.co.uk" className="inline-flex items-center gap-2 text-lg font-bold text-white hover:text-brand transition-colors">
              <Mail className="h-5 w-5 text-brand" /> info@hertsshield.co.uk
            </a>
          </div>
...
export function PageHeaderSpacer() {
  // Push content below the fixed header (logo + nav row)
  return <div className="pt-64 sm:pt-72 lg:pt-80" aria-hidden />;
}
