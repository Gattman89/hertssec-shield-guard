    ...
    >
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 flex items-center justify-between h-14">
        <nav className="hidden lg:flex items-center gap-8 mx-auto">
          {navLinks.map((l) => (
            <Link key={l.to} to={l.to} className="text-sm font-semibold text-foreground/85 hover:text-brand transition-colors uppercase tracking-wide [&.active]:text-brand">
              {l.label}
            </Link>
          ))}
          <Button asChild size="lg" className="bg-brand hover:bg-brand/90 text-white font-semibold uppercase tracking-wide ml-4">
            <Link to="/contact" hash="quote">Request a Quote</Link>
          </Button>
        </nav>
      ...
      {open && (
        <div className="lg:hidden bg-background border-t border-border">
          <div className="px-4 py-4 flex flex-col gap-4">
            {navLinks.map((l) => (
              <Link key={l.to} to={l.to} onClick={() => setOpen(false)} className="text-sm font-semibold uppercase tracking-wide text-foreground/85">
                {l.label}
              </Link>
            ))}
            <Button asChild className="bg-brand hover:bg-brand/90 text-white font-semibold uppercase">
              <Link to="/contact" hash="quote" onClick={() => setOpen(false)}>Request a Quote</Link>
            </Button>
          </div>
        </div>
      )}
        ...
        <div className="max-w-3xl">
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <Button asChild size="lg" className="bg-brand hover:bg-brand/90 text-white h-12 px-7 text-base font-semibold uppercase tracking-wide shadow-[0_20px_50px_-15px_rgba(179,0,0,0.6)]">
              <Link to="/contact" hash="quote">Get a Free Quote</Link>
            </Button>
...
export function About() {
  return (
    <section id="about" className="py-16 sm:py-20 bg-background scroll-mt-40">
...
export function Services() {
  return (
    <section id="services" className="py-16 sm:py-20 bg-card relative scroll-mt-40">
...
export function WhyUs() {
  return (
    <section id="why" className="py-16 sm:py-20 bg-background relative overflow-hidden scroll-mt-40">
...
export function Areas() {
  return (
    <section id="areas" className="py-16 sm:py-20 bg-card scroll-mt-40">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 grid lg:grid-cols-2 gap-10 items-center">
        <div>
          <SectionHeader
...
export function Quote() {
  ...
  return (
    <section id="quote" className="py-16 sm:py-20 relative overflow-hidden scroll-mt-40" style={{ background: "var(--gradient-hero)" }}>
...
export function Careers() {
  return (
    <section id="careers" className="py-16 sm:py-20 relative overflow-hidden scroll-mt-40" style={{ background: "var(--gradient-hero)" }}>
      <div className="absolute inset-0 opacity-10" style={{ backgroundImage: "radial-gradient(circle at 80% 20%, #B30000 0%, transparent 50%)" }} />
...
export function Contact() {
  return (
    <section id="contact" className="py-16 sm:py-20 bg-background scroll-mt-40">
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-10 grid md:grid-cols-4 gap-8">
        ...
        <div>
          ...
          <ul className="space-y-2 text-sm text-muted-foreground">
            {navLinks.map((l) => (
              <li key={l.to}>
                <Link to={l.to} className="hover:text-brand transition-colors">{l.label}</Link>
              </li>
            ))}
          </ul>
        </div>
