...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:image:alt", content: "HertsShield Security Services — SIA Licensed Security in Hertfordshire" },
      { name: "twitter:image", content: "https://hertsshield.co.uk/hertsshield-preview.png" },
      { name: "twitter:image:alt", content: "HertsShield Security Services — SIA Licensed Security in Hertfordshire" },
    ],
    links: [
