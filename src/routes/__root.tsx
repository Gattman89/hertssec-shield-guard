...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:site_name", content: "HertsShield Security Services" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "HertsShield Security Services" },
      { name: "twitter:description", content: "SIA-licensed manned guarding, event security, and construction site security across Hertfordshire." },
